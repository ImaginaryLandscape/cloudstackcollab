...
DATABASES = {
    "default": {
        ...
        "NAME": "cloudstack2013",                       # Or path to database file if using sqlite3.
        "USER": "cloudstack2013",                             # Not used with sqlite3.
        "PASSWORD": "cloudstack2013",                         # Not used with sqlite3.
...
# Subdirectory of COMPRESS_ROOT to store the cached media file
...
ROOT_URLCONF = "cloudstack2013.urls"
